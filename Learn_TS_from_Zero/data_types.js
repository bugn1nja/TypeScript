...
// // This is called dynamic typing in JavaScript, where a variable can hold values of different data types at different times during the execution of a program.

// // This Keyword is created using Ai
...
// // In this example, "this" refers to the person1 object, allowing us to access its properties firstName and lastName within the fullName method.
...
// console.log(getFullName.call(person2)); //will print Jane Smith
// // Here, we use the call method to invoke getFullName with person2 as its context. 
// // As a result, "this" inside the fullName function now refers to person2, allowing us to access its properties.
...
// user.welcomemessage(); //will print Mujaddid, Welcome to my website !

// user.username = "Mustabin";
// user.welcomemessage(); //will print Mustabin, Welcome to my website !
